 ...
 */
 ...
 #define SENSOR_MODEL_ID_CLIENT  0x1414
 #define SENSOR_MODEL_ID_SERVER  0x1415
 
 // model opcodes definitions
 ...
 static const esp_ble_mesh_client_op_pair_t senser_model_op_pair[] = {
     { SENSOR_MODEL_OPCODE_GET, SENSOR_MODEL_OPCODE_STATUS },
     { SENSOR_MODEL_OPCODE_SET, SENSOR_MODEL_OPCODE_STATUS },
 };
 
 static esp_ble_mesh_client_t sensor_client_model = {
     .op_pair_size = ARRAY_SIZE(senser_model_op_pair),
     .op_pair = senser_model_op_pair,
 };
 ...
 static esp_ble_mesh_model_op_t sensor_model_op[] = {
     ...
     ESP_BLE_MESH_MODEL_OP(SENSOR_MODEL_OPCODE_STATUS,
                         sizeof(ipac_ble_mesh_msg_sensor_model_get_t)),
     ESP_BLE_MESH_MODEL_OP_END,
 };
 
 static esp_ble_mesh_model_t vnd_models[] = {
     ESP_BLE_MESH_VENDOR_MODEL(CID_ESP, SENSOR_MODEL_ID_SERVER,
     sensor_model_op, NULL, NULL),
 };
